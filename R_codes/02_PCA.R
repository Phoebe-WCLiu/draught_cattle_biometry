...
ggsave("MC_PCA.png", MC_PCA, width = 10, height = 6, dpi = 300)
...
MC_PCA_Contribution = ggpubr::ggarrange(MC_PCA_PC1, MC_PCA_PC2,
                                 ncol = 2, nrow = 1,
                                 common.legend = T,
                                 legend = "right")
ggsave("MC_PCA_Contribution.png", plot = MC_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
...
ggsave("MT_PCA.png", MT_PCA, width = 10, height = 6, dpi = 300)
...
MT_PCA_Contribution = ggpubr::ggarrange(MT_PCA_PC1, MT_PCA_PC2,
                                        ncol = 2, nrow = 1,
                                        common.legend = T,
                                        legend = "right")
ggsave("MT_PCA_Contribution.png", plot = MT_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
...
ggsave("PH1_PCA.png", PH1_PCA, width = 10, height = 6, dpi = 300)
...
PH1_PCA_Contribution = ggpubr::ggarrange(PH1_PCA_PC1, PH1_PCA_PC2,
                                        ncol = 2, nrow = 1,
                                        common.legend = T,
                                        legend = "right")
ggsave("PH1_PCA_Contribution.png", plot = PH1_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
...
ggsave("PH1A_PCA.png", PH1A_PCA, width = 10, height = 6, dpi = 300)
...
PH1A_PCA_Contribution = ggpubr::ggarrange(PH1A_PCA_PC1, PH1A_PCA_PC2,
                                         ncol = 2, nrow = 1,
                                         common.legend = T,
                                         legend = "right")
ggsave("PH1A_PCA_Contribution.png", plot = PH1A_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
...
ggsave("PH1P_PCA.png", PH1P_PCA, width = 10, height = 6, dpi = 300)
...
PH1P_PCA_Contribution = ggpubr::ggarrange(PH1P_PCA_PC1, PH1P_PCA_PC2,
                                          ncol = 2, nrow = 1,
                                          common.legend = T,
                                          legend = "right")
ggsave("PH1P_PCA_Contribution.png", plot = PH1P_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
...
ggsave("PH2_PCA.png", PH2_PCA, width = 10, height = 6, dpi = 300)
...
PH2_PCA_Contribution = ggpubr::ggarrange(PH2_PCA_PC1, PH2_PCA_PC2,
                                          ncol = 2, nrow = 1,
                                          common.legend = T,
                                          legend = "right")
ggsave("PH2_PCA_Contribution.png", plot = PH2_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
...
ggsave("PH2A_PCA.png", PH2A_PCA, width = 10, height = 6, dpi = 300)
...
PH2A_PCA_Contribution = ggpubr::ggarrange(PH2A_PCA_PC1, PH2A_PCA_PC2,
                                         ncol = 2, nrow = 1,
                                         common.legend = T,
                                         legend = "right")
ggsave("PH2A_PCA_Contribution.png", plot = PH2A_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
...
PH2P_PCA<- ggplot(pca_points, aes(x = PC1, y = PC2,fill = as.factor(PCA_Type))) +
  geom_point(size = 3.5, color = "black",shape=21) +
  geom_polygon(data = pca_hull,
               aes(fill = PCA_Type,
                   colour = PCA_Type),
...
ggsave("PH2P_PCA.png", PH2P_PCA, width = 10, height = 6, dpi = 300)
...
PH2P_PCA_Contribution = ggpubr::ggarrange(PH2P_PCA_PC1, PH2P_PCA_PC2,
                                          ncol = 2, nrow = 1,
                                          common.legend = T,
                                          legend = "right")
ggsave("PH2P_PCA_Contribution.png", plot = PH2P_PCA_Contribution,width = 10, height = 5, dpi = 300, limitsize = FALSE)
